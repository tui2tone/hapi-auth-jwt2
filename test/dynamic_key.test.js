...
//       "(Dynamic_Key) No tenant specified should fail!");
//
//     t.end();
//   });
// });
...
//   // use the token as the 'authorization' header in requests
//   var token = JWT.sign({ id: 123, "name": "Charlie",
//     "tenant": "princeFamilyPaper" }, 'michaelscott');
//   var options = {
//     method: "POST",
//     url: "/privado",
//     headers: { authorization: "Bearer " + token }
...
//     console.log(" - - - - RESPONSE: ");
//     console.log(response.result);
//     t.equal(response.statusCode, 500, "No tentant found should fail!");
//     t.end();
// });
